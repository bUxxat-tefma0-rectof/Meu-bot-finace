...
# Importante para deploy no Render e primeiro uso

STORAGE_DIRS = [
    "storage",
    "storage/media",
    "storage/media/products",
    "storage/media/categories",
    "storage/media/banners",
    "storage/media/temp",
...
# Cria arquivos .gitkeep se não existirem (para Git)
for dir_path in STORAGE_DIRS:
...
# Reduz logging de bibliotecas muito verbosas
